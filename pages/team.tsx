...
const people = [
  ...
  },
  {
    name: 'Latif',
    role: 'COO',
    imageUrl: '/images/team/Latif.jpeg',
  ...
  },
  {
    ...
    bio: `Lynn provides compliance and operational advisory services. She has provided advisory services for cryptocurrency start-ups and exchanges in the area of compliance, risk management, ALM, trading strategies, ICO token structuring & due diligence. She has +25 years in both industry and advisory services, working for firms such as Merrill Lynch, JP Morgan Chase, and Deloitte. And, has provided advisory services to global financial institutions, asset managers, and funds in compliance, risk management, regulatory requirements, portfolio analysis, strategies, and valuation. Co-author whitepaper “The Missing Link: How a Distributed Ledger System Can Support Global Climate Action.” Published in the areas of asset management, risk management and valuation. Series 65 License, Uniform Investment Advisor Law Examination. B.S. in Economics The Wharton School, University of Pennsylvania.</span>.`,
  },
];
