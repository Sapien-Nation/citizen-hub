  ...
  return (
    <>
      ...
      <div className="m-auto overflow-hidden relative">
        ...
        <div className="container mx-auto px-6 p-6 bg-white bg-gradient-to-r from-sapien to-sapien-blue-100 rounded-4xl mt-12">
          <div className="mb-16 text-center">
            <h2 className="text-base text-grey font-semibold tracking-wide uppercase ">
              Features
            </h2>
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 dark:text-white sm:text-4xl">
              A Social Network of DAOs, powered by the Sapien Passport.
            </p>
          </div>
